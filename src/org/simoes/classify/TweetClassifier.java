...
//		String text = status.getText();
	...
	public static void main(String[] args) {
		ColumnDataClassifier cdc = new ColumnDataClassifier("/Users/csimoes/workspace-juno/twitter-feed/conf/training.properties");
		
		File trainFile = new File("/Users/csimoes/workspace-juno/twitter-feed/conf/training.properties");
		...
		Category c = tc.classifyText(text);
